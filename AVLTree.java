...
{  
   ...
   private int insertComparisons = 0; // counter for insert comparisons
   private int searchComparisons = 0; // counter for search comparisons 
   ...
   public BinaryTreeNode<dataType> insert ( dataType d, BinaryTreeNode<dataType> node )
   {
      if (node == null)
         ...
         insertComparisons++; // counting the comparisons 
   ...
   {  
      searchComparisons++; // counting comparisons 
      if (d.compareTo (node.data) == 0) 
         return node;
      else if (d.compareTo (node.data) < 0)
